...
def get_blockchain():
    response: GetBlockchainResponse = {'blockchain': blockchain, 'length': len(blockchain)}
...
def validate_blockchain():
    ...
    if is_blockchain_valid:
        response: str = 'Blockchain valid'
    else:
        response: str = 'Blockchain invalid'
...
def replace_chain():
    global blockchain
    is_chain_replaced, longest_chain = find_longest_chain(blockchain, blockchain_nodes)
